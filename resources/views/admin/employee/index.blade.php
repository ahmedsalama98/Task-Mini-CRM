...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> {{ __('site.EMPLOYEES') }}</li>
        </ol>
    </nav>
    <div class="row justify-content-between">
        ...
        <div class="col-auto">
            ...
            @if (Auth::user()->hasPermission('employees-create'))
                <a class="btn btn-success " href="{{ route('admin.employees.create') }}">{{ __('site.CREATE') }}</a>
            @else
                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.employees.index') }}" <div class="row">
                                <div class="col-lg-4">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover p-8">
                    <thead>
                        <tr>
                            <th class="cell">ID</th>
                            <th class="cell">{{ __('site.FIRST_NAME') }}</th>
                            <th class="cell">{{ __('site.LAST_NAME') }}</th>
                            <th class="cell">{{ __('site.EMAIL') }}</th>
                            <th class="cell">{{ __('site.PHONE') }}</th>
                            <th class="cell">{{ __('site.COMPANY') }}</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($employees as $employee)
                            <tr>
                                ...
                                <td class="cell">{{ $employee->company ?  $employee->company->name:'-'}}</td>

                                <td class="cell">{{ $employee->created_at->format('d M Y  h:i A') }}</td>
