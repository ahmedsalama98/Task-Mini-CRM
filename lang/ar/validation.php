...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'subscribe_email' => 'البريد الالكتروني',

        'sign_email' => 'البريد الالكتروني',
        ...
        "old_password"=>" رمز المرور القديم",
        "new_password"=>" رمز المرور الجديد",
        "new_password_confirmation"=>"تاكيد رمز المرور الجديد",
        "why_apply"=>"لماذا تريد ان تتقدم لتلك الوظيفة",
        "about"=>"اكتب نبذه عنك",
        "file"=>"الملف",
